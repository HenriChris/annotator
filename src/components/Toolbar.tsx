...
// }) {
//     const base =
//         "px-4 py-2 rounded text-white font-medium text-sm cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150 whitespace-nowrap";
//     const variants = {
...
// const Divider = () => <div className="w-px h-[30px] bg-[#34495e]" />;
...
//                 <span className="text-sm text-gray-300 truncate max-w-[200px]" title={imageName}>
//                     {imageName}
//                 </span>

//                 <span className="text-xs text-gray-400 font-semibold whitespace-nowrap">
//                     {annotatedCount}/{totalImages} ({percentage}%)
//                 </span>
//             </div>
//         </div>
//     );
...
//             <span className="px-3 py-1 bg-[#34495e] rounded text-xs font-semibold uppercase w-[80px] text-center">
//                 {mode}
//             </span>
//         </div>
//     );
...
//             <label className="text-sm text-gray-200 whitespace-nowrap">Color:</label>
//             <ColorPicker
//                 colors={COLORS}
//                 selected={color}
...
// }) {
//     return (
//         <div className={`flex items-center gap-2 px-3 py-1 bg-[#34495e] rounded text-sm ${disabled ? 'opacity-50' : ''}`}>
//             <input
//                 type="checkbox"
//                 id="occluded"
//                 checked={isOccluded}
...
//             />
//             <label htmlFor="occluded" className={`select-none whitespace-nowrap ${disabled ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
//                 Occluded
//             </label>
//         </div>
//     );
...
//         <div
//             role="toolbar"
//             className="fixed top-0 left-0 right-0 bg-[#2c3e50] text-white z-50 shadow-md"
//         >
//             <div className="flex items-center px-5 py-2 gap-3 flex-wrap">
//                 {/* Navigation */}
//                 <NavigationSection
//                     {...{
//                         currentIndex,
...
//                 {/* Color */}
//                 <ColorSection {...{ color, onColorChange, disabled: !isDrawMode }} />

//                 <Divider />

//                 {/* Occlusion */}
//                 <OcclusionToggle {...{ isOccluded, onOccludedChange, disabled: !isDrawMode }} />
...
//         gray: `bg-[${THEME.divider}] hover:bg-[${THEME.hoverBg}]`,
//     };
...
// const Divider = memo(() => (
//     <div className={`w-px h-[30px] bg-[${THEME.divider}]`} />
// ));
...
//                 <span className="text-xs sm:text-sm text-gray-200 whitespace-nowrap flex items-center gap-1">
//                     <span
...
//                         {hasAnnotations ? "✓" : "○"}
//                     </span>
//                     <span className="tabular-nums">{currentIndex + 1}/{totalImages}</span>
//                 </span>
...
//                 <span className="text-[10px] sm:text-xs text-gray-400 font-semibold whitespace-nowrap bg-[#1a252f] px-1.5 sm:px-2 py-0.5 sm:py-1 rounded tabular-nums">
...
//             <span
//                 className={`px-2 sm:px-3 py-1 bg-[${THEME.divider}] rounded text-[10px] sm:text-xs font-semibold uppercase w-[60px] sm:w-[80px] text-center`}
...
//     return (
//         <div
//             className={`flex items-center gap-1 sm:gap-2 transition-opacity ${disabled ? 'opacity-30 pointer-events-none' : ''}`}
...
//     return (
//         <div
//             className={`flex items-center gap-2 px-2 sm:px-3 py-1 bg-[${THEME.divider}] rounded text-xs sm:text-sm transition-opacity w-[100px] sm:w-[110px] ${disabled ? 'opacity-30 pointer-events-none' : ''}`}
//             aria-disabled={disabled}
//         >
//             <input
//                 type="checkbox"
...
//             <label
//                 htmlFor="occluded"
//                 className={`select-none whitespace-nowrap ${disabled ? 'cursor-not-allowed' : 'cursor-pointer'}`}
//             >
//                 Occluded
//             </label>
//         </div>
...
//             className={`fixed top-0 left-0 right-0 bg-[${THEME.toolbar}] text-white z-50 shadow-lg`}
//         >
//             <div className="flex flex-wrap items-center px-2 sm:px-5 py-2 gap-2 sm:gap-3">
//                 {/* Navigation */}
//                 <NavigationSection {...navigationProps} />

//                 <Divider />

//                 {/* Mode, Color, Occlusion - wrap on small screens */}
